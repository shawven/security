...
@RestController
public class GenericOAuth2Endpoint {

    private final Logger logger = LoggerFactory.getLogger(GenericOAuth2Endpoint.class);
    ...
    public GenericOAuth2Endpoint(TokenEndpoint tokenEndpoint, AuthorizationServerTokenServices services,
