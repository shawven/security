 ...
 * @date 2019-04-19
 */
public class GenericConnectAuthenticationFilterPostProcessor implements ConnectAuthenticationFilterPostProcessor {

    private AuthenticationSuccessHandler authenticationSuccessHandler;
    private AuthenticationFailureHandler authenticationFailureHandler;

    public GenericConnectAuthenticationFilterPostProcessor(AuthenticationSuccessHandler authenticationSuccessHandler,
