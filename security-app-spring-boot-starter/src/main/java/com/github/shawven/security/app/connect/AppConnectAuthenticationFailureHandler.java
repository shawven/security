 ...
 * 社交登陆APP环境下认证失败处理器
 */
public class AppConnectAuthenticationFailureHandler implements AuthenticationFailureHandler {

    private final Logger logger = LoggerFactory.getLogger(AppConnectAuthenticationFailureHandler.class);
